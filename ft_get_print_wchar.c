...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_get_print_wchar.c                                   :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tmashigo <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/11 11:24:25 by tmashigo          #+#    #+#             */
/*   Updated: 2018/08/11 11:24:31 by tmashigo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char						ft_get_print_wchar(wchar_t wc)
{
	...
	size = size_wchar(wc);
	if (size == 1)
		return (ft_get_print_char(wc));
	curr_byte = (240 << (4 - size)) | (wc >> ((size - 1) * 6));
	res += ft_get_print_char(curr_byte);
	size--;
	while (size--)
	{
